...
from HighPerformance.BisectUtil import BisectUtil
...
class WordImage(object):
    ...
    def __init__(self, img_path, new_size=(200, 200)):
        #
        ...
        self.analysis_pkl_path = None  # 分析结果的保存路径
        #
    ...
    def get_img_data(self):
        ...
        all_china_str = a.get_all_chinese_character()
        a.convert_chinese_to_word_pic(all_china_str, self.img_data_folder)
        a.word_analysis(self.img_data_folder, self.analysis_pkl_path)
...
if __name__ == '__main__':
    ...
    # a = WordImage(r'C:\Users\Administrator\Desktop\123.jpg', (int(1920/3), int(1080/3)))
    a = WordImage(r'C:\Users\Administrator\Desktop\123.jpg', (225, 335))
    a.analysis_pkl_path = r'D:\Code\Util_Util\Z_for_CSDN\word_pic\data\del.pkl'
    a.save_path = r'C:\Users\Administrator\Desktop\beer.jpg'
    a.do_process()
