...
# print(issue.timedelta(xun=-1).get_issue_str())

issue = HTHTIssue('201901310740')
print(issue.get_year_str(), issue.get_month_str(), issue.get_day_str())

a = issue.timedelta(months=1, xun=-2)
print(a.get_year_str(), a.get_month_str(), a.get_day_str())
