/* ----------------------------------------------------------------------------
	Sample source code for Himawari Standard Data with updated calibration coefficient
...
typedef struct{
	...
	/* updated calibration coefficient */
	double			coeff_mjd;		/* 11 */
	double			gain_cnt2rad_mod;	/* 12 */
	double			cnst_cnt2rad_mod;	/* 13 */
	char			spareV[105];		/* 14 */
