...
class Game(object):
    ...
    def __init__(self):
        ...
        self.bar_pos = pygame.Rect(self.bar_pos_x, SCREEN_SIZE[1] - BAR_SIZE[1], BAR_SIZE[0], BALL_SIZE[1])  # FIXME 定义一个矩阵
    ...
    def run(self):
        ...
        while True:
            ...
            self.screen.fill(bg_color)  # 屏幕中填充颜色
            self.bar_pos.left = self.bar_pos_x  # FIXME ？
            pygame.draw.rect(self.screen, WHITE, self.bar_pos)

            ## 球移动
            self.ball_pos.bottom += self.ball_dir_y * 3
            pygame.draw.rect(self.screen, WHITE, self.ball_pos)  # FIXME 画一个矩阵，看看有没有画其他图形的模块
            ...
            pygame.display.update()  # FIXME 更新软件界面显示
            self.clock.tick(60)  # FIXME 应该是刷新的帧率，
