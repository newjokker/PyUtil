...
cell_style_new = a.get_cell_style(font_style_new, True, True)
...
merge_info = [{'merge_value': u'支持单元格合并', 'merge_range': (0, 0, 1, 1),
               'cell_style': a.get_cell_style(font_style_5, True, 'LEFT')},
              {'merge_value': u'支持单元格合并', 'merge_range': (0, 3, 1, 3),
               'cell_style': a.get_cell_style(font_style_5, True, 'RIGHT')}]
