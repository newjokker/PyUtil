...
"""
实现简单的条形图、饼图、等需要的出图
因为涉及的参数过多，这边只能做一个例子，而不是写好通用的函数
"""
...
if __name__ == "__main__":
    ...
    dataList = [[52, 55, 63, 53], [44, 66, 55, 41], [34, 56, 35, 54], [44, 65, 55, 41],  [44, 65, 55, 41]]
    color_list = ['lightskyblue', 'orange', 'grey', 'lightskyblue']
    bar(dataList, 1, 2, ('001', '002', '003', '004', '005'), save_path, ['A', 'B', 'C', 'D'], color_list)
